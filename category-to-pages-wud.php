...
function cattopage_wud_site_page(){
	...
	wp_register_script('cattopage_wud_cat_img_script', plugins_url( 'js/jquery.ctp_wud_min.js', __FILE__ ), array('jquery'), null, true );
...
function cattopage_wud_update(){
		global $ctp_version;
			...
			if (get_option('cattopage_wud_icon')=='') {update_option('cattopage_wud_icon', 0);}
...
function cattopage_wud_activation( $plugin ) {
    if( $plugin == plugin_basename( __FILE__ ) ) {			
			...
			update_option('cattopage_wud_icon', 0);
