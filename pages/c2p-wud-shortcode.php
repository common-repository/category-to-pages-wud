...
if(!function_exists('cattopage_wud_current_cat_tag')){
	function cattopage_wud_current_cat_tag($atts) {
		...
		$showicontag = "" ;
		if(get_option('cattopage_wud_icon') == 0 ){
			$showiconcat = "<span class='wudicon wudicon-category' ".$iconsize."> </span>";
		}
		if(get_option('cattopage_wud_icon') == 0 ){
			$showicontag = "<span class='wudicon wudicon-tag' ".$iconsize.">  </span>";
		}		
				if(!empty($cats_title)){
					$cats_title = "<".$pp." class='ctp-wud-title' ".$ppstyle.">".$showiconcat.$cats_title."</".$pp.">";
				}
				if(!empty($tags_title)){
					$tags_title = "<".$pp." class='ctp-wud-title' ".$ppstyle.">".$showicontag.$tags_title."</".$pp.">";
				}
		}
