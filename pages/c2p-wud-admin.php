...
function cattopage_wud_settings_page(){
	...
	if ( isset($_POST['ctp_opt_hidden']) && $_POST['ctp_opt_hidden'] == 'Y' && isset( $_POST['cattopage-wud-save'] ) && wp_verify_nonce($_POST['cattopage-wud-save'], 'cattopage-wud-check')) {
		...
		if ( isset($_POST['cattopage_wud_icon']) && $_POST['cattopage_wud_icon']=='1') {$cattopage_wud_icon = '1';} else{$cattopage_wud_icon ='0';}
		update_option('cattopage_wud_icon', filter_var($cattopage_wud_icon, FILTER_SANITIZE_STRING));	
	...
	// READ the used vaiables
		...
		$cattopage_wud_icon = get_option('cattopage_wud_icon');	
...
//RIGHT START
	echo "<div class='rightdiv'>";
		...
		echo "<div class='ctp-wud-wrap-5'>";
			echo'<div id="ctp-wud-tip"><b class="ctp-trigger">?</b><div class="tooltip">'.__("Hide the folder Icon", "category-to-pages-wud").' <br><br>'.__("If activated","category-to-pages-wud").':<br>'.__("It wil hide the WUD folder icons", "category-to-pages-wud").'<br>'.__("If not activated", "category-to-pages-wud").':<br>'.__("It will show the WUD folder icons.", "category-to-pages-wud").'</div></div>';
			echo '<label><b>'.__("Hide/Show the folder icons", "category-to-pages-wud").' </b></label><input id="cmn-toggle-17" class="cmn-toggle cmn-toggle-round" name="cattopage_wud_icon" type="checkbox" value="1" '. checked( $cattopage_wud_icon, "1", false ) .'/><label for="cmn-toggle-17" class="ctp-wud-right"></label>';
		echo "<br></div>";
